...
import { faBars,faArrowLeft,faFilm,faHouse,faMusic,faList,faGear,faBoxesPacking,faMagnifyingGlass } from '@fortawesome/free-solid-svg-icons'
                            ...
                            <header className=""> 
                                <div className='d-flex'>
                                    ...
                                    <div className='ms-auto mt-1'>
                                        <button type="button" className="btn btn-close btn-light" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                                    </div>
                                </div>
