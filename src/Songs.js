            ...
            <>
                <ul className="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <li className="nav-item">
                        <button className="nav-link"><h2 className='text-white'>Music</h2></button>
                    </li>
                    <li className="nav-item mt-2">
                        <button className="nav-link text-white active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button">Songs</button>
                    </li>
                    <li className="nav-item mt-2">
                        <button className="nav-link text-white" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button">Albums</button>
                    </li>
                    <li className="nav-item mt-2">
                        <button className="nav-link text-white" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button">Artists</button>
                    </li>
                </ul>
                ...
                <div className="tab-content mt-2" id="pills-tabContent">
                    <div className="tab-pane show active fade container" id="pills-home" role="tabpanel">
                        <Musiclist/>
                    </div>
